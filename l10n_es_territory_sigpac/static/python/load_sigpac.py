...
if num_args == 8:
    ...
    print("\nExample 1 (one SHP):\n")
    print(
        "python load_sigpac.py 127.0.0.1 5432 dbname odoo10moval passwd /tmp/rec_30045_2022_20220113.shp 25830"
    )
    print("\nExample 2 (two SHP):\n")
    print(
        "python load_sigpac.py 127.0.0.1 5432 dbname odoo10moval passwd /tmp/rec_03142_2022_20220113.shp#/tmp/rec_30045_2022_20220113.shp 25830"
    )
    print("\nExample 3 (three SHP, a SHP with filter):\n")
    print(
        'python load_sigpac.py 127.0.0.1 5432 dbname odoo10moval passwd \'/tmp/rec_03142_2022_20220113.shp#/tmp/rec_30045_2022_20220113.shp("poligono">=529 and "poligono"<=539)#/tmp/rec_30045_2022_20220113.shp\' 25830'
    )
    sys.exit(255)
