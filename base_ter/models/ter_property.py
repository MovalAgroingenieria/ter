...
class TerProperty(models.Model):
    ...
    def write(self, vals):
        ...
        if (
            same_parcelmanager_propertyowner
            and old_partner_id
    ...
    def action_refresh_properties_layer(self, from_backend=False):
        config = self.env["ir.config_parameter"].sudo()
        gis_viewer_epsg = config.get_param("base_ter.gis_viewer_epsg", False)
    ...
    def action_show_parcels(self):
        ...
        act_window = {
            ...
            "context": {
                "default_partner_id": current_property.partner_id.id,
