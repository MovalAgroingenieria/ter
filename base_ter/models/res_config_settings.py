...
class ResConfigSettings(models.TransientModel):
    ...
    def update_geometry(self, old_epsg, new_epsg):
        ...
        for layer in layers or []:
            ...
            error_message = ""
            try:
                self.env.cr.execute("DROP VIEW IF EXISTS ter_gis_parcel_model")
                self.env.cr.execute(
