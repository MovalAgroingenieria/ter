...
class TestTerParceltagViews(TransactionCase):
    def test_parceltag_action_view_ids_has_no_trailing_comma(self):
        ...
        self.assertIn("ter_parceltag_view_tree", action.view_ids.mapped("view_id").mapped("xml_id"))
        self.assertIn("ter_parceltag_view_form", action.view_ids.mapped("view_id").mapped("xml_id"))
